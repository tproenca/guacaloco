...
public class HostNewVirtualMachineAction extends SnippetAction {

    private static final String ICON = "/icons/host_createvm.png";
    private static final String DESCRIPTION = "New Virtual Machine";
    private static final String TEMPLATE_NAME = "HostNewVirtualMachine.vm";

    public HostNewVirtualMachineAction(StructuredViewer viewer) {
        super(viewer);
    }
