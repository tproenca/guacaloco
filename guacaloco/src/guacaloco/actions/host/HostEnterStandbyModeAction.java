...
public class HostEnterStandbyModeAction extends SnippetAction {

    private static final String ICON = "/icons/host_standby.png";
    private static final String DESCRIPTION = "Enter Standby Mode";
    private static final String TEMPLATE_NAME = "HostEnterStandbyMode.vm";

    public HostEnterStandbyModeAction(StructuredViewer viewer) {
        super(viewer);
    }
