...
public class HostPowerOnAction extends SnippetAction {

    private static final String ICON = "/icons/host_poweron.png";
    private static final String DESCRIPTION = "Power On";
    private static final String TEMPLATE_NAME = "HostPowerOn.vm";

    public HostPowerOnAction(StructuredViewer viewer) {
        super(viewer);
    }
