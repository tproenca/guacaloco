...
public class HostEnterMaintenanceModeAction extends SnippetAction {

    private static final String ICON = "/icons/host_maintenance.png";
    private static final String DESCRIPTION = "Enter Maintenance Mode";
    private static final String TEMPLATE_NAME = "HostEnterMaintenanceMode.vm";

    public HostEnterMaintenanceModeAction(StructuredViewer viewer) {
        super(viewer);
    }
