...
public class VMTakeSnapshotAction extends SnippetAction {

    private static final String ICON = "/icons/vm_snapshot.png";
    private static final String DESCRIPTION = "Take Snapshot...";
    private static final String TEMPLATE_NAME = "TakeSnapshotVirtualMachine.vm";

    public VMTakeSnapshotAction(StructuredViewer viewer) {
        super(viewer);
    }
