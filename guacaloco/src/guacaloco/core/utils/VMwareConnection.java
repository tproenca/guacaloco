...
public class VMwareConnection {
    ...
    public VMwareConnection(String serverName, String userName, String password) throws Exception {
        ...
        ManagedObjectReference serviceInstance = ObjectUtils.createMoRef("ServiceInstance",
                "ServiceInstance");
     ...
     *             if an exception occurred
     */
    public List<ObjectContent> findAllObjects(String objectType, String... properties)
            throws Exception {
    ...
    public ObjectContent findObject(String objectType, String name, String... properties)
        ...
        } catch (InvalidPropertyFaultMsg ipfm) {
